    ...
    try:
        ...
        if scenes:
            ...
            for s in scenes:
                ...
                filler = ""
                entry_length = len(s.strip()) + len(rpcurl) + 2
                for i in range(1, 512 - entry_length):
                    filler = filler + "#"
                        
                f.write(s.strip() + '\t' + rpcurl + '\t' + filler +'\n')
            f.close()
            ...
            #hadoop_run_command = hadoop_run_command + ' -D mapreduce.jobtracker.expire.trackers.interval=172800000'
            #hadoop_run_command = hadoop_run_command + ' -D mapreduce.tasktracker.healthchecker.script.timeout=172800000'
