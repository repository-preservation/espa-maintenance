...
if __name__ == '__main__':
    ...
    group.add_argument('--listscenes', dest='scenes', nargs='*', help='scenes to search for in the cache')
    group.add_argument('--is_nlaps', dest='scenes', nargs='*', help='scenes to search the nlaps inventory for')
